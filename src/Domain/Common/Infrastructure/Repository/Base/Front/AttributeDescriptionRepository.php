 ...
 *
 * @psalm-method list<AttributeDescription>   findAll()
 * @psalm-method list<AttributeDescription>   findBy(array $criteria, array $orderBy = null, $limit = null, $offset = null)
 *
 * @template-extends Repository<AttributeDescription>
 */
