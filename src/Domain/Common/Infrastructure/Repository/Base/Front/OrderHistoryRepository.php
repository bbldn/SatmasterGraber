...
use App\Domain\Common\Domain\Entity\Base\Front\OrderHistory;
 ...
 *
 * @psalm-method list<OrderHistory>   findAll()
 * @psalm-method list<OrderHistory>   findBy(array $criteria, array $orderBy = null, $limit = null, $offset = null)
 *
 * @template-extends Repository<OrderHistory>
 */
