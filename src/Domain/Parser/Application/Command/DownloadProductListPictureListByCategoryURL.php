...
use App\Domain\Parser\Application\CommandHandler\DownloadProductListPictureListByCategoryURLHandler\CommandHandler;

/**
 * @CQRS\CommandHandler(class=CommandHandler::class)
 */
class DownloadProductListPictureListByCategoryURL implements Command
{
    private string $url;
